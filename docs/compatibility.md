...
| PPSA09804 | GRIS | 01.001.000 | Booting | Deep Unity/IL2CPP + audio init; ~91,000 HLE imports, zero unresolved | Garbage deref/call from IL2CPP class/reflection with no real metadata backend | `il2cpp_class_from_name`, `il2cpp_runtime_invoke`, object/array construction (~160 IL2CPP functions still stubbed) | [`PPSA09804.md`](game-notes/PPSA09804.md) |
